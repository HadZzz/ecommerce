                    ...
                    <div class="sm:text-center lg:text-left">
                        ...
                        <div class="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                            <div class="rounded-md shadow">
                                <a href="<?php echo e(route('products.index')); ?>" class="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-red-500 hover:bg-red-600 md:py-4 md:text-lg md:px-10">
            ...
            <div class="mt-10 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                ...
                <div class="group relative bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300 ease-in-out">
                    <div class="relative w-full h-80 bg-white rounded-lg overflow-hidden group-hover:opacity-75 transition-opacity duration-300">
                        <img src="<?php echo e($category->image_url ?? 'https://images.unsplash.com/photo-1445205170230-053b83016050?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1471&q=80'); ?>" 
                    ...
                    <div class="px-6 py-4">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <a href="/category/<?php echo e($category->slug); ?>" class="inline-flex items-center px-3 py-2 border border-transparent text-sm font-medium rounded-md text-red-600 bg-red-100 hover:bg-red-200">
    ...
    <div class="bg-white py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mt-10 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <div class="group relative bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300 ease-in-out">
                    <div class="relative w-full h-64 bg-white rounded-t-lg overflow-hidden group-hover:opacity-75 transition-opacity duration-300">
                        <img src="<?php echo e($product->image_url ?? 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80'); ?>" 
                    ...
                    <div class="px-6 py-4">
                        ...
                        <p class="text-gray-500 text-sm mb-4"><?php echo e(Str::limit($product->description, 100)); ?></p>
                        <div class="flex items-center justify-between">
                            <span class="text-xl font-bold text-gray-900">
                                Rp <?php echo e(number_format($product->price, 0, ',', '.')); ?>

                            </span>
                            <form action="<?php echo e(route('cart.add', ['product' => $product->id])); ?>" method="POST" class="cart-form">
                                <?php echo csrf_field(); ?>
            ...
            <div class="mt-12 text-center">
                <a href="<?php echo e(route('products.index')); ?>" class="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-red-500 hover:bg-red-600">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/naf/mbahhadi/ecom/resources/views/shop/home.blade.php ENDPATH**/ ?>