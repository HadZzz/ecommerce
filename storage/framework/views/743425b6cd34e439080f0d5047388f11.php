    ...
    <div class="bg-white rounded-xl shadow-lg overflow-hidden">
        <div class="p-6 sm:p-8">
            <div class="text-center mb-8">
                ...
                <p class="mt-2 text-gray-600">Order Number: <?php echo e($order->order_number); ?></p>
            </div>
            ...
            <div class="bg-gray-50 rounded-lg p-6 mb-8">
                ...
                <div class="mt-6 border-t border-gray-200 pt-4">
                    <div class="flex justify-between text-sm">
                        ...
                        <span class="font-medium text-gray-900">Rp <?php echo e(number_format($order->total_amount, 0, ',', '.')); ?></span>
                    </div>
                    ...
                    <div class="flex justify-between text-base font-medium mt-4">
                        ...
                        <span class="text-green-600">Rp <?php echo e(number_format($order->total_amount, 0, ',', '.')); ?></span>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                    ...
                    <div class="bg-gray-50 rounded-lg p-4">
                        <p class="text-gray-600 whitespace-pre-line"><?php echo e($order->shipping_address); ?></p>
                    </div>
                </div>
                <div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/naf/mbahhadi/ecom/resources/views/shop/checkout-success.blade.php ENDPATH**/ ?>