    ...
    <div class="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div class="space-y-4">
                ...
                <ul class="space-y-2">
                    <li>
                        <a href="<?php echo e(route('products.index')); ?>" class="text-gray-400 hover:text-white text-sm flex items-center">
        ...
        <div class="mt-8 pt-8 border-t border-gray-800">
            <div class="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                <p class="text-gray-400 text-sm">
                    &copy; <?php echo e(date('Y')); ?> ShopApp. All rights reserved.
                </p>
...
<?php /**PATH /home/naf/mbahhadi/ecom/resources/views/layouts/footer.blade.php ENDPATH**/ ?>