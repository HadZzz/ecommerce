                ...
                <div class="bg-white rounded-xl shadow-lg p-6 sticky top-20">
                    ...
                    <div class="border-t border-gray-200 pt-4 space-y-4">
                        <div class="flex justify-between text-sm">
                            ...
                            <span class="font-medium text-gray-900">Rp <?php echo e(number_format($total, 0, ',', '.')); ?></span>
                        </div>
                        <div class="flex justify-between text-sm">
                        ...
                        <div class="flex justify-between text-base font-medium">
                            ...
                            <span class="text-red-600">Rp <?php echo e(number_format($total, 0, ',', '.')); ?></span>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/naf/mbahhadi/ecom/resources/views/shop/checkout.blade.php ENDPATH**/ ?>