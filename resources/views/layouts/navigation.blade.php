    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="flex items-center">
                ...
                <!-- Cart -->
                @auth
                    <a href="{{ route('cart.index') }}" class="relative p-2 text-gray-600 hover:text-red-500 transition-colors">
                ...
                <div class="hidden sm:flex sm:items-center sm:ml-6">
                    ...
                    <div class="ml-3 relative">
                        ...
                        @else
                            <div class="space-x-4">
                                <a href="{{ route('login') }}" class="text-sm text-gray-700 hover:text-red-500">Login</a>
                                <a href="{{ route('register') }}" class="text-sm text-gray-700 hover:text-red-500">Register</a>
                            </div>
                        @endauth
                    </div>
                </div>
